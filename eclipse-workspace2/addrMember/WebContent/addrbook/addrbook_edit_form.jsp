<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="addrMember.*"%>
<jsp:useBean id="ab" scope="request" class="addrMember.AddrBook"/>
...
<table border="1">
  ...
  <tr>
    <th>email</th>
    <td><input type="email" name="ab_email" maxlength="50" value="<%=ab.getAb_email() %>"></td>
  </tr>
    <tr>
    <th>전화번호</th>
