...
<c:forEach items='${orderList}' var='dto'>
							<tr>
								...
								<td>${dto.order_st}${startPage}${endPage}${totCnt}</td>
							</tr>
</c:forEach>
					</tbody>
			</table>
			...
			<div class="page_nav">
				...
				<li>
					<c:if test="${startPage > viewCnt}"><a href='order_list?pageNo=${startPage-viewCnt}' onclick=''><</a></c:if>
					</li>
<c:forEach  var = "i" begin="${startPage}" end="${endPage}">		
				...
				<li>
					<c:if test="${endPage+1 <= totCnt}"><a href='order_list?pageNo=${endPage+1}'>></a></c:if>
					</li>
